...
?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-body">
                    <form action="<?php echo  $GLOBALS['view_path']?>category_update" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                        <img src="<?php echo $GLOBALS['view_path'].$categoryedit['logo'];?>" class="img-fluid w-25">
                                    </div>
